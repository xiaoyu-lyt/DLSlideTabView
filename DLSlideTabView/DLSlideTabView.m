...
- (void)loadData {
    ...
    [(UILabel *)self.titleScrollView.subviews.firstObject setTextColor:[UIColor redColor]];
...
- (void)singleTapHandler:(UITapGestureRecognizer *)tap {
    ...
    [(UILabel *)tap.view setTextColor:[UIColor redColor]];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    if (scrollView == _contentScrollView) {
        ...
        if ([currentTabView isKindOfClass:[UILabel class]]) {
            [(UILabel *)currentTabView setTextColor:[UIColor redColor]];
        }
        [UIView animateWithDuration:0.3 animations:^{
